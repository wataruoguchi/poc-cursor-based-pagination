...
//       // Note: The current implementation has a bug where logger is not passed
//       // This test will fail until the repository is fixed
//       expect(() => {
...
//
//       // Note: This test will fail until the repository implementation is fixed
//       expect(async () => {
